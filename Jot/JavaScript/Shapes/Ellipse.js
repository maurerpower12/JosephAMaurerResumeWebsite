//ELLIPSE CLASS
var Ellipse = function (startX, startY, endX, endY, fillColor, outlineColor, outlineThickness) {
    this.name = 'E';
    if (startX === undefined) {
        this.centerX = 0;
        this.centerY = 0;
...
Ellipse.prototype.SetDimensions = function (centerX, centerY, radiusx, radiusy, fillColor, outlineColor, outlineThickness) {
...
Ellipse.prototype.DrawBox = function (context) {
    context.beginPath();
