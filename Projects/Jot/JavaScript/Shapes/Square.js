//SQUARE CLASS
var Square = function (startX, startY, endX, endY, fillColor, outlineColor, outlineThickness) {
    this.name = 'S';
    if (startX === undefined) {
        this.startX = 0;
        this.startY = 0;
...
Square.prototype.SetDimensions = function (startX, startY, width, height, fillColor, outlineColor, outlineThickness) {
...
Square.prototype.DrawBox = function (context) {
    context.beginPath();
